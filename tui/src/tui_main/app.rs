...
impl AutoStash {
    pub fn new(config: &Config, stack_sender: mpsc::Sender<Vec<LineDifference>>, version_sender: mpsc::Sender<Vec<LineDifference>>, ) -> Result<AutoStash, Box<dyn std::error::Error>> {
